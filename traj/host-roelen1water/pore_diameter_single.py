...
folder_path = '' #sys.argv[1]  #'/afs/crc.nd.edu/user/m/mfarshad/Private/ML/traj/pore_diameter/'
...
pdb = os.path.join(folder_path, f'host_{run_1}.gro')
trr = os.path.join(folder_path, f'host_{run_1}.trr')
u = mda.Universe(pdb, trr)
    
ha = hole2.HoleAnalysis(u, select='(index 0 to 101 or index 223 to 244 or index 372 or index 374 or index 376)',
