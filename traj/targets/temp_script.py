...
# PDF file name: * will be replaced by sed in the bash script
pp = PdfPages("hist+pmf" + str(run_1) + "_*.pdf")
...
bs_file = "/afs/crc/group/whitmer/Data-MF-10/amber/*/Umbrella_sampling/umbrella/run_long_1/bsResult.xvg"
...
ax.set_title(
    r"*: $\Delta G^\ddagger = %.2f\;(\mathrm{kcal\cdot mol^{-1}})$" % diff,
    fontsize=22
)
...
print("*", free_energy_cal_ns, free_energy_cal_mo, free_energy_cal_lit)
