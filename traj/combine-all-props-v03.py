...
rdkit_prop = pd.read_csv(f'all-host-props/host_{host_name}_props-reviewed.csv')
...
rdkit_prop.to_csv(f'all-host-props-nopore/host_{host_name}_all_props-reviewed.csv', index=False)
