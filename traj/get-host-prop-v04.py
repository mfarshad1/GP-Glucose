...
# Calculate all properties (excluding formal charge)
props = {
    'host_name': host_name,
...
# Calculate charge from MOL2 file
mol2_charge = get_charges_from_mol2(host_path)
props['total_charge'] = mol2_charge  # Changed from 'mol2_total_charge' to 'total_charge'
